...
#define PITCH_GYRO_ABSOLUTE_PID_KP -105.0f
#define PITCH_GYRO_ABSOLUTE_PID_KI 0.0f
#define PITCH_GYRO_ABSOLUTE_PID_KD 15.0f
#define PITCH_GYRO_ABSOLUTE_PID_MAX_OUT 1000.0f
#define PITCH_GYRO_ABSOLUTE_PID_MAX_IOUT 1000.0f

//yaw 角度环 角度由陀螺仪解算 PID参数以及 PID最大输出，积分输出
#define YAW_GYRO_ABSOLUTE_PID_KP -70.0f //改p
#define YAW_GYRO_ABSOLUTE_PID_KI 0.0f
#define YAW_GYRO_ABSOLUTE_PID_KD 0.0f //改d
...
typedef struct
{
  ...
  pid_type_def gimbal_motor_curr_pid;
